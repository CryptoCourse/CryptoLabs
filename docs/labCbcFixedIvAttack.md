...
Проникнувшись простотой реализации режима CBC он незамедлительно зашифровал свой пин-код от банковской карты этим режимом,
...
**NB.** Если ваша реализация рассчитана на то, что вы должны обязательно успеть за секунду (т.е. рассчитываете на то, что IV не изменится - это плохая реализация).
