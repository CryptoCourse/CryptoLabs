...
`byte[] Encrypt(byte[] data, byte[] iv = null)` - ф-я шифрование на заданном ключе

`byte[] Decrypt(byte[] data, byte[] iv = null)` - ф-я шифрование на заданном ключе, где
